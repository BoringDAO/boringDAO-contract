...
module.exports = async (deployer, network, accounts) => {
    ...
    let geneTs = Math.floor(Date.now() / 1000)+30;
    ...
    await srf.notifyRewardAmount(bBTC.address, 3*24*60*60, toWei("2000"));
    await srf.notifyRewardAmount(pptoken.address, 3*24*60*60, toWei("2000"));
