...
contract SatellitePoolRewardsLock is IStakingRewards, RewardsDistributionRecipient, ReentrancyGuard {
    ...
    constructor(
        ...
        stakingTokenDecimal = 10**_stakingTokenDecimal;
    }
    ...
    function rewardPerToken() public override view returns (uint256) {
        ...
        return
            rewardPerTokenStored.add(
                lastTimeRewardApplicable().sub(lastUpdateTime).mul(rewardRate).mul(stakingTokenDecimal).div(_totalSupply)
            );
    }
